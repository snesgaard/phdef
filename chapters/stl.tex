...
\frame{
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \begin{figure}
      \subfloat[Skin]{\includegraphics[width=0.49\linewidth]{figures/stlskinraw}}\hfill
      \subfloat[Fat]{\includegraphics[width=0.49\linewidth]{figures/stlfatraw}}
    \end{figure}
    \captionsetup[subfloat]{position=below, labelformat=empty}
    \vspace{-1cm}
    \begin{figure}
      \subfloat[Meat]{\includegraphics[width=0.49\linewidth]{figures/stlmuscleraw}}
    \end{figure}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
    \captionsetup[subfloat]{position=above, labelformat=empty}
