...
%\begin{comment}
\frame{
  \frametitle{Importance of Subsurface Scattering}
  \begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{figures/bssrdf_nope}
    \hfill
    \includegraphics[width=0.45\textwidth]{figures/bssrdf_yeah}
  \end{figure}
  Skin rendering without and with subsurface scattering, on the left and right respectively~\cite{jensen2001practical}.
}
%\end{comment}
...
\frame{
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \begin{figure}
      \subfloat[Skin]{\includegraphics[width=0.49\linewidth]{figures/skin}}\hfill
      \subfloat[Fat]{\includegraphics[width=0.49\linewidth]{figures/fat}}
    \end{figure}
    \captionsetup[subfloat]{position=below, labelformat=empty}
    \vspace{-1cm}
    \begin{figure}
      \subfloat[Meat]{\includegraphics[width=0.49\linewidth]{figures/muscle}}
    \end{figure}
  \end{minipage}\hfill
  \begin{minipage}[t]{0.48\linewidth}
    \captionsetup[subfloat]{position=above, labelformat=empty}
    \begin{figure}
      \subfloat[Gray Codes~\cite{posdamer1982surface}]{\includegraphics[width=0.49\linewidth]{figures/pattern}}\hfill
      \subfloat[Phase Shifting~\cite{Huntley1993a}]{\includegraphics[width=0.49\linewidth]{figures/patterns_nstep}}
    \end{figure}
    \captionsetup[subfloat]{position=below, labelformat=empty}
    \vspace{-1cm}
    \begin{figure}
      \subfloat[Modulated Phase Shifting~\cite{chen2008modulated}]{\includegraphics[width=0.49\linewidth]{figures/patterns_modulated}}\hfill
      \subfloat[Micro Phase Shifting~\cite{gupta2012micro}]{\includegraphics[width=0.49\linewidth]{figures/patterns_micro}}
    \end{figure}
  \end{minipage}
}
...
\frame{
  ...
  \end{figure}
  Chalk layer thickness is about 50$\mu$m
}
