...
\frame{
  ...
  \end{center}
  Repeated experiments with different camera models. Fitted line is $y = 0.96x + 4.06$.
}
...
\frame{
  ...
  \end{itemize}
  Consider implemention Metric Proj. matrix completion algorithm for filling missing observations.
}
